...
-- Commands ----------------------
----------------------------------
vim.api.nvim_create_user_command('Rg', 'silent grep! <args> | copen | cwindow', { nargs = "+" })
...
api.nvim_set_keymap("n", "<leader>d", ":lua vim.diagnostic.setqflist()<CR>:cwindow<CR>", opts)
...
local on_attach = function(client, bufnr)
  ...
  map("n", "gi", "<cmd>lua vim.lsp.buf.implementation()<CR>:cwindow<CR>")
  map("n", "gr", "<cmd>lua vim.lsp.buf.references()<CR>:cwindow<CR>")
